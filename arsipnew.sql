...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 15, 2020 at 04:23 AM
...
CREATE TABLE `cek_kelengkapan` (
  ...
  `card_x` varchar(20) NOT NULL,
  `inform_consent` varchar(20) NOT NULL,
  `pemantauan` varchar(20) NOT NULL,
  `pengkajian_kadar` varchar(20) NOT NULL,
  `sbar` varchar(20) NOT NULL,
  `skrining` varchar(20) NOT NULL,
  `assesmen_awal` varchar(25) NOT NULL,
  `transfer_ruangan` varchar(25) NOT NULL,
  `resume` varchar(25) NOT NULL,
  `ringkasan_mk` varchar(25) NOT NULL,
  `assesmen_dpjp` varchar(25) NOT NULL,
  `pengkajian_bayi` varchar(25) NOT NULL,
  `pengkajian_perawat` varchar(25) NOT NULL,
  `asuhan_gizi` varchar(25) NOT NULL,
  `perencanaan_pasien_pulang` varchar(25) NOT NULL,
  `obs_tanda_vital` varchar(25) NOT NULL,
  `obs_suhu_nadi` varchar(25) NOT NULL,
  `laporan_operasi` varchar(25) NOT NULL,
  `assesmen_prabedah` varchar(25) NOT NULL,
  `assesmen_praanastesi` varchar(25) NOT NULL,
  `assesmen_keperawatan` varchar(25) NOT NULL,
  `timbang_terima` varchar(25) NOT NULL,
  `set_marking` varchar(25) NOT NULL,
  `ceklist_keselamatan` varchar(25) NOT NULL,
  `ppi` varchar(25) NOT NULL,
...
('18147184', 'Aji Pratama', '2020-08-11 00:00:00', 'Laki-laki', 'adadljalkdjald', 'Terbaca');
...
(1, 'admin', 'admin', 'Aji Pratama', 1, '090880', '2020-08-11 02:04:03', '2020-08-11 11:16:32'),
